...
#modify BUG_ID:EWWQ-868 chenyu 20190514 (start)
BOOT_LOGO = e557_cq_9052c_61_p0_hdplus1520
#mofify BUG_ID:EWWQ-868 chenyu 20190514 (end)
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
#modify BUG_ID:EWWQ-889 chenyu 20190514 (start)
MTK_CMAS_SUPPORT = yes
#modify BUG_ID:EWWQ-889 chenyu 20190514 (end)
...
#add BUG_ID:EWWQ-889 chenyu 20190514 (start)
MTK_SIP_SUPPORT = yes
OPPO_SIP_SUPPORT = yes
#add BUG_ID:EWWQ-889 chenyu 20190514 (end)
...
#camera-----------------------
CUSTOM_HAL_IMGSENSOR = gc2385_mipi_raw gc23850_mipi_raw gc0310_mipi_yuv gc8034_mipi_raw gc5025_mipi_raw ov8865_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = gc2385_mipi_raw gc8034_mipi_raw ov8865_mipi_raw
CUSTOM_HAL_SUB_IMGSENSOR = gc23850_mipi_raw gc5025_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = gc0310_mipi_yuv

CUSTOM_KERNEL_IMGSENSOR = gc2385_mipi_raw gc23850_mipi_raw gc0310_mipi_yuv gc8034_mipi_raw gc5025_mipi_raw ov8865_mipi_raw
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc2385_mipi_raw gc8034_mipi_raw ov8865_mipi_raw
CUSTOM_KERNEL_SUB_IMGSENSOR = gc23850_mipi_raw gc5025_mipi_raw
...
#add by liutao 20190412 start {
#otg
CUSTOM_KERNEL_OTG = no

#hall
CUSTOM_KERNEL_HALL = no

#notificationLight
CUSTOM_KERNEL_NOTIFICATION_LIGHT = yes

#add by liutao 20190412 end }
...
WTK_BUILD_VERNO = CUBOT_R19_9052C_V05_20190812
WTK_INTERNAL_BUILD_VERNO = E557_CQ_9052C_61_P0_V1.4.1_S190812

#End For Common----------------------------------------------------------}

#add AQJJ-67 xudong.zhang 20181110(start)
#WTK_CUSTOM_DATA_ROAMING_SUPPORT # yes
#add AQJJ-67 xudong.zhang 20181110(end)

#add by wuzhi.peng for AQJJ-80 start
WTK_STRESS_TEST = yes
#add by wuzhi.peng for AQJJ-80 end

#add EWWQ-912 xudong.zhang 20190515(start)
WTK_LED_SETTING = yes
#add EWWQ-912 xudong.zhang 20190515(end)

#add EWWQ-875 xudong.zhang 20190516 (start)
WTK_VOLTE_DEFAULT_OFF = yes
#add EWWQ-875 xudong.zhang 20190516 (end)

# Modify by HZH on 2019/6/13 for EWWQ-1116 start
WTK_TARGET_BOARD_NAME = CUBOT
WTK_PRODUCT_NAME = R19_EEA
...
# A: delete OdmmMusic. chenchunyong 20190520 {
WTK_MUSIC2_OVERRIDES_ODMMUSIC = yes
# A: }

#adupsfota start
USE_CQ_ADUPS_FOTA=yes
...
FACE_SAGA_WITH_ICON = yes

#add EWWQ-908 by wusahnfei 20190528 start
WTK_PTP_LABEL = R19
WTK_MTP_LABEL = R19
WTK_INTERNAL_SD_LABEL = R19
WTK_DEFAULT_BLUETOOTH_NAME = R19
#add EWWQ-908 by wusahnfei 20190528 start
#add EWWQ-893 by wusahnfei 20190528 start
REMOVE_BAIDULOCATION = yes
#add EWWQ-893 by wusahnfei 20190528 start
...
#add EWWQ-1087 by chenyu 20190613 for bootsound default start
WTK_BOOTSOUND_OFF = yes
#add EWWQ-1087 by chenyu 20190613 for bootsound default end

# add BUG_ID:EWWQ-1110 chenyu 20190613 (start)
WTK_SHUTDOWN_ANIMATION = yes
# add BUG_ID:EWWQ-1110 chenyu 20190613 (end)

#add bug:EWWQ-1206 chenyu 20190620 (start)
CY_SEARCHLAUNCHER_QS_QSB_IN_TOP = yes
#add bug:EWWQ-1206 chenyu 20190620 (end)
...
# A: Bug_id:add gangyun bokeh. chenchunyong 20190723 {
GANGYUN_BOKEH_SUPPORT = yes
# A: }

PLATFORM_BASE_OS = CUBOT/R19_EEA/R19:9/P00610/1562334911:user/release-keys
